...
exports.COMMUNITY_TOTALS = exports.POOLS = void 0;
exports.poolEconomics = poolEconomics;
...
function poolEconomics(pool) {
    const soloCost = pool.distanceKm * economics_1.COST_MODEL.transportPerKm;
...
exports.COMMUNITY_TOTALS = {
    activePools: exports.POOLS.length,
    farmers: new Set(exports.POOLS.flatMap((p) => p.members.map((m) => m.name))).size,
    savedThisMonth: exports.POOLS.reduce((sum, p) => sum + poolEconomics(p).savingEach * p.members.length, 0),
};
